...
--- For the destination the user can enter a range of effects as one would in the command line. (e.g. 1 Thru 20 - 5 + 42)  -> Accepted operators are: {Thru, thru, +, -} --TODO change function to remove thru value after minus
---
---Usage: 
